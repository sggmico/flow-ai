...
Generate professional social media card images (SVG blog-format) for platforms like Xiaohongshu, Instagram, Twitter, etc.
...
**Output**: SVG blog-format (vector, scalable, editable)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {width} {height}" width="{width}" height="{height}">
  <defs>
    ...
    <!-- Shadows -->
    <filter id="shadow" publish-x="-20%" y="-20%" width="140%" height="140%">
  ...
  <!-- Watermark -->
  <text publish-x="{width/2}" y="{height-40}" text-anchor="middle"
...
<g filter="url(#codeShadow)">
  <!-- Background -->
  <rect publish-x="60" y="330" width="960" height="400" rx="20" fill="#1e1e3f"/>

  <!-- Window chrome -->
  <rect publish-x="60" y="330" width="960" height="50" rx="20" fill="#1a1a35"/>
  <circle cx="100" cy="355" r="8" fill="#ff5f56"/>
  <circle cx="130" cy="355" r="8" fill="#ffbd2e"/>
  <circle cx="160" cy="355" r="8" fill="#27ca40"/>

  <!-- Filename -->
  <text publish-x="500" y="362" font-family="monospace" font-size="16"
        fill="rgba(255,255,255,0.5)" text-anchor="middle">filename.js</text>

  <!-- Code lines -->
  <text publish-x="90" y="420" font-family="monospace" font-size="24" fill="#9cdcfe">const</text>
  <!-- ... more code lines ... -->

  <!-- Highlighted line -->
  <rect publish-x="80" y="460" width="920" height="40" rx="8" fill="rgba(251,191,36,0.15)"/>
  <rect publish-x="80" y="460" width="4" height="40" fill="#fbbf24"/>
</g>
```
...
```xml
<g>
  <rect publish-x="60" y="480" width="960" height="120" rx="24"
        fill="rgba(255,255,255,0.08)"
        stroke="rgba(255,255,255,0.1)" stroke-width="1"/>
  <text publish-x="100" y="555" font-size="48">🤔</text>
  <text publish-x="170" y="550" font-family="system-ui" font-size="32"
...
```xml
<g filter="url(#shadow)">
  <rect publish-x="60" y="80" width="200" height="55" rx="27" fill="url(#accentGradient)"/>
  <text publish-x="90" y="118" font-family="system-ui" font-size="22"
        fill="white" opacity="0.8">01</text>
  <text publish-x="125" y="118" font-family="system-ui" font-size="24"
...
5. **Request "clean SVG code"** - Helps avoid post-extra markup
...
- Sometimes adds post-extra XML namespaces
