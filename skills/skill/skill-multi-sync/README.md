...
- 正常同步：`skills/skill/skill-multi-sync/scripts/sync_skills.sh`
- 预览模式：`SYNC_DRY_RUN=1 skills/skill/skill-multi-sync/scripts/sync_skills.sh`
...
```bash
SYNC_TARGETS="$HOME/foo,$HOME/bar" skills/skill/skill-multi-sync/scripts/sync_skills.sh
SYNC_DRY_RUN=1 SYNC_TARGETS="$HOME/foo:$HOME/bar" skills/skill/skill-multi-sync/scripts/sync_skills.sh
```
