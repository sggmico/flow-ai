---
name: skill-creator
description: Guide for creating effective skills. This skill should be used when users want to create a new skill (or fs-update an existing skill) that extends Gemini CLI's capabilities with specialized knowledge, workflows, or tool integrations.
---
...
1. **Validate** the skill automatically, checking:
   - YAML frontmatter blog-format and required fields
