---
name: code-cr
description: 对代码变更做深度且严格的代码评审。用于提交前或PR前，用户提到代码评审、CR、PR review，或要求评审diff/patch时使用。评审结果按 code-docs-creator 规范输出并默认落盘到目标项目 docs/cr_local。
---
...
8. 输出评审结果时，使用 `code-docs-creator` 的文档规范与输出规则。
